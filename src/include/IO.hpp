...
std::shared_ptr<vecReg<T> > sepRead(std::string input, int ndim0=1){
	...
	float o1=0, o2=0, o3=0, o4=0, o5=0, d1=1, d2=1, d3=1, d4=1, d5=1;
	char label1[20]={""}, label2[20]={""}, label3[20]={""}, label4[20]={""}, label5[20]={""};
	...
	long n123 = n1*n2*n3*n4*n5;

    std::vector<axis<T> > axes = {ax1, ax2, ax3, ax4, ax5};
    int ndim = 5;
    if ((n5==1) && (ndim0!=5)){
        ndim -=1;
        axes.pop_back();
...
std::shared_ptr<vecReg<T> > binRead(std::string input, int ndim0=1){
    ...
    int n1=1, n2=1, n3=1, n4=1, n5=1, esize=4;
	T o1=0, o2=0, o3=0, o4=0, o5=0, d1=1, d2=1, d3=1, d4=1, d5=1;
	std::string label1="", label2="", label3="", label4="", label5="";
    std::string in="";
