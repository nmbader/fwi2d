...
struct param{
    ...
    bool normalize=0, integrate=0, double_difference=0, interferometry=0, normalize_obj_func=false; // trace-by-trace normalization, time integration, double difference between consecutive traces, interferometry by deconvolution of consecutive traces over residuals, normalize objective function 
