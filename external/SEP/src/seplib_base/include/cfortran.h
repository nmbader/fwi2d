...
#if defined(CLIPPERFortran) || defined(pgiFortran) || defined(XLFGCC)
#ifndef f2cFortran
#define f2cFortran
#endif
#endif
...
/* Split #if into 2 because some HP-UX can't handle long #if */
/* add XLFGCC because namespace problem with default behavior RGC*/
#if !(defined(NAGf90Fortran)||defined(f2cFortran)||defined(hpuxFortran)||defined(apolloFortran)||defined(sunFortran)||defined(IBMR2Fortran)||defined(CRAYFortran)||defined(XLFGCC))
#if !(defined(mipsFortran)||defined(DECFortran)||defined(vmsFortran)||defined(CONVEXFortran)||defined(PowerStationFortran)||defined(AbsoftUNIXFortran)||defined(AbsoftProFortran)||defined(SXFortran)||defined(XLFGCC))
